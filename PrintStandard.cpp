...
const char* stdName[numStandards] = { "Pre-C++11", "C++14", "C++17", "C++20", "C++23", "C++26"};
...
long getCPPStandard()
{
    ...
    return -1;
#else
    //_cplusplus is the intended way to query the language code(as defined by the language standards)
    return __cplusplus;    
#endif    
}
...
int main()
{
    ...
    if (standard == -1)
    { 
        std::cout << "Error: Unable to determine your language. Sorry.\n";
        return 0;
    }
